...
import { jobs, allLocations } from "@/data/jobs";
...
function JobsPage() {
  ...
  const filtered = useMemo(() => {
    return jobs.filter((j) => {
      const matchesSearch = !search || j.title.toLowerCase().includes(search.toLowerCase()) || j.employerName.toLowerCase().includes(search.toLowerCase()) || j.description.toLowerCase().includes(search.toLowerCase());
  ...
  }, [search, categoryFilter, locationFilter, remoteFilter]);
